...
class TestInterfaz:  
    ...
    def test_asignacion_curso(self):
        ...
        actual = self.driver.find_element(By.XPATH, "//div[contains(text(),'Maestro-Curso agregado exitosamente')]").text
        print("********", actual)  
        ...
        time.sleep(2)
        actual = self.driver.find_element(By.XPATH, "//div[contains(text(),'Maestro-Curso eliminado exitosamente')]").text
        print("********", actual)  
